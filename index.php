                ...
                <div class="col-12 col-md-7 col-lg-8">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="post-2" role="tabpanel" aria-labelledby="post-2-tab">
                            <!-- Single Feature Post -->
                            <div class="single-feature-post video-post bg-img" style="background-image: url(assets/img/bg-img/8.jpg);">
                                <!-- Play Button -->
                                <a href="video-post.php" class="btn play-btn"><i class="fa fa-play" aria-hidden="true"></i></a>
                        ...
                        <div class="tab-pane fade" id="post-3" role="tabpanel" aria-labelledby="post-3-tab">
                            <!-- Single Feature Post -->
                            <div class="single-feature-post video-post bg-img" style="background-image: url(assets/img/bg-img/9.jpg);">
                                <!-- Play Button -->
                                <a href="video-post.php" class="btn play-btn"><i class="fa fa-play" aria-hidden="true"></i></a>
