                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="archive-list.php">Archives</a></li>
                                    <li><a href="#">Pages</a>
                                        <ul class="dropdown">
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="archive-catagory-view mb-50 d-flex align-items-center justify-content-between">
                        ...
                        <div class="view-options">
                            <a href="archive-grid.php" class="active"><i class="fa fa-th-large" aria-hidden="true"></i></a>
                            <a href="archive-list.php"><i class="fa fa-list-ul" aria-hidden="true"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                ...
                                <div class="post-content">
                                    ...
                                    <a href="single-post.php" class="post-title">May fights on after Johnson savages Brexit approach</a>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                ...
                                <div class="post-content">
                                    <a href="#" class="post-cata cata-sm cata-success">Sports</a>
                                    <a href="single-post.php" class="post-title">Thailand cave rescue: Boys 'doing well' after spending night</a>
                                    <div class="post-meta d-flex">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                ...
                                <div class="post-content">
                                    <a href="#" class="post-cata cata-sm cata-success">Sports</a>
                                    <a href="single-post.php" class="post-title">Theresa May battles Brexitee backlash amid disquiet</a>
                                    <div class="post-meta d-flex">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="single-post-area mb-50">
                                ...
                                <div class="post-content">
                                    <a href="#" class="post-cata cata-sm cata-success">Sports</a>
                                    <a href="single-post.php" class="post-title">Theresa May battles Brexiteer backlash amid disquiet</a>
                                    <div class="post-meta d-flex">
                                        <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 22</a>
                                        <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 16</a>
                                        <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 15</a>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget mb-70">
                        <!-- Logo -->
                        <a href="index.php" class="foo-logo d-block mb-4"><img src="assets/img/core-img/logo2.png" alt=""></a>
